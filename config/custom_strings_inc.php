...
if( SYS_COMPANY == 'unosoft' ) {
    ...
    $s_status_enum_string = '10:új,20:kérdés,25:ajánlat kérés,27:tisztázás,30:ajánlat,40:elfogadva,50:folyamatban,55:kérdés,60:teszt,70:teszt&nbsp;ok,80:átadva,90:lezárva';

    if ( SYS_COMPANY === 'kobe' ) {
        $s_status_enum_string = '10:új,20:kérdés,25:ajánlat kérés,27:tisztázás,30:ajánlat,40:elfogadva,50:folyamatban,55:kérdés,60:teszt,70:teszt&nbsp;ok,80:átadva,85:élesre tehető,90:lezárva,99:joker';
    }
    ...
    $s_projection_enum_string = '10:támogatás,20:hiba,50:megrendelés,51:SPL-Fejlesztés,52:Lekérdezés,53:adatmódosítás,54:oktatás,55:konzultáció';
}
