SELECT A.id AS "mantisjegy_szám", 
	   ...
	   A.date_submitted AS "bejelentés_ideje", 
       munkaoraban(A.date_submitted, A.atadas) AS "Unosoft_átadás",
       A.sla AS "SLA_Szerződés",
       (A.sla > munkaoraban(A.date_submitted, A.atadas)) AS "SLA_kiértékelés"
