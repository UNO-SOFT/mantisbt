SELECT A.id AS "Mantisjegy_száma",
       ...
       A.date_submitted AS "Biztosíto_bejelentette", 
       A.reakcio AS "Unosoft_válasz",
       munkaoraban(A.date_submitted, A.reakcio) AS "Unosoft_reakcióidő",
       A.sla, 
       (A.sla > munkaoraban(A.date_submitted, A.reakcio)) AS "SLA_kiértékelés"
