...
?>
			<tr>
				...
				<td>
					...
					<?php if( ON == config_get( 'time_tracking_required', OFF ) ) { ?>
					<span class="required"><input type="text" required="true" name="time_tracking" class="stopwatch_time input-sm" size="8" placeholder="hh:mm:ss" /></span>
					<?php } else { ?>
